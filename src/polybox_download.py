...
def download_and_extract_polybox_data(
...
#     # You can specify a folder path here, or leave it as None to use the default
#     download_and_extract_polybox_data(folder_path=None)